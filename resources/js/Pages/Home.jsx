                            ...
                            >
                                <div className="mb-5">
                                    ...
                                    <div className="mt-5">
                                        ...
                                        <p className="mt-1 text-neutral-400">
                                            With the aim of optimizing customer
                                            interactions and boosting brand
                                            loyalty, the team at Preline
                                            leveraged Mailchimp's powerful tools
                                ...
                                <div className="mb-5">
                                    ...
                                    <div className="mt-5">
                                        ...
                                        <p className="mt-1 text-neutral-400">
                                            ...
                                            Preline embarked on a mission to
                                            revolutionize the e-commerce
                                            experience for a fictitious fashion
                                            brand, "StyleAura.".
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="mb-5">
                                    ...
                                    <div className="mt-5">
                                        ...
                                        <p className="mt-1 text-neutral-400">
                                            ...
                                            project delivery and enhancing
                                            collaboration among development
                                            teams, Preline leveraged GitLab's
                                            comprehensive suite of tools and
                                            Preline's expertise in digital
                                            product development.
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div className="max-w-5xl px-4 xl:px-0 py-10 lg:pt-20  mx-auto">
                        <div className="max-w-3xl mb-10 lg:mb-14">
                            ...
                            <p className="mt-1 text-neutral-400">
                                ...
                                brand development and website or product
                                deployment.
                            </p>
                        </div>
